...
<head>
    ...
    <!-- Ini untuk laravel, hapus jika tidak menggunakan Laravel -->
...
<body class="leading-normal tracking-normal" style="font-family: 'Montserrat', sans-serif">
    ...
    <nav class="flex items-center justify-between flex-wrap bg-purple-300 p-7 px-20">
        <div class="flex items-center flex-shrink-0 text-black mr-6">
            ...
            <span class="font-bold tracking-wider text-xl">
                &nbsp PENGADUAN NASABAH BANK ARTHAYA</span>
        </div>
    ...
    <!--Hero-->
    <div class="pt-24 px-16 bg-purple-200">
    ...
    <footer class="text-center font-medium bg-purple-400 py-5">
        © 2022 PENGADUAN NASABAH BANK ARTHAYA | By
