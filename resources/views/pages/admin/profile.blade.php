            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4 mr-4">
                    ...
                    <input type="number"
                        ...
                        placeholder="Masukkan NIK (maksimal 16 digit)" value="{{ $data->nik }}" required autofocus>
                </div>
                <div class="mb-4 mr-4">
                ...
                <div class="mb-4 mr-4">
                    ...
                    <input type="number"
                        pattern="^[0-9]{12}$"
                        oninput="if(this.value.length > 12) this.value = this.value.slice(0, 12)" class="mt-1 p-2 border rounded-md w-full"
                        name="phone" placeholder="Nomor Handphone 12 digit" value="{{$data->phone}}" required autofocus>
                </div>
                <div class="mb-4 mr-4">
                    <label for="password"
